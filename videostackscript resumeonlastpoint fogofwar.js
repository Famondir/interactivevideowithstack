...
<div id="videos">
	...
	<track kind="chapters" src="https://moodle.htw-berlin.de/draftfile.php/1230510/user/draft/655704143/dummyvideo.vtt" srclang="en"  label="English" default>
	</video>
</div>
...
<script type="text/javascript">
	...
	video.onloadedmetadata = function() {
		...
		waitForElm('.vjs-play-control').then((elm) => {
			if (!video.paused) {
				elm.classList.add('vjs-playing'); // ändere das Abspielsymbol passend zum Playerstatus
			}
		});
...
/* LastTime: <span id="zaehlershow">0</span> s */